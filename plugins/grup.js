...
async (conn, mek, m, {
    ...
    try {
        ...
        return await conn.sendMessage(from, {
            text: `*Shadow md by Group Admins 👨‍💻💗:*\n\n${admins}`,
...
async (conn, mek, m, {
    ...
    try {
        ...
        return await conn.sendMessage(from, {
            text: `Shadow md by Mentioning everyone 👨‍💻💗:\n\n${members}`,
            mentions
        }, { quoted: mek });
...
try{                   
	...
	reply('✅ GROUP ADDMIN PROMOTE BY BOT OWNER')
await conn.sendMessage(from, { react: { text: `💫`, key: mek.key }}) 
} catch (e) {
reply('*කරුනාකර පසුව උත්සකා කරන්න.❌*')
l(e)
}
}) 
...
reply('*කරුනාකර පසුව උත්සහ කරන්න ❌*')
l(e)
}
})
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        const goodbye = q
        if (!goodbye) return reply('HI WELCOME NEW MEMBAR💗👨‍💻.')
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        const welcome = q
        if (!welcome) return reply('BY  I MIS YOU PLEASE COME BACK 💗👨‍💻.')
